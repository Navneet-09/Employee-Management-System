...
{
    JTextField  Tfname, Tsalary, Tadd, Tphone, Tmail, Tdesig, Tedu;
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==submit)
        {
            ...
            try{
                Conn c= new Conn();
                String query ="update employee set fathername ='"+fname+"', salary = '"+salary+"', address='"+address+"', phone='"+phone+"', email ='"+email+"', education='"+education+"', post ='"+designation+"' where id = '"+employeeid+"'";
